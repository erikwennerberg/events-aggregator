...
import com.appdynamics.views.dashboard.DashboardView;
import com.appdynamics.views.masterdetail.QueryDetailView;

/**
 * The main view is a top-level placeholder for other views.
 */
@JsModule("./styles/shared-styles.js")
@PWA(name = "FutureOfAnalytics", shortName = "FutureOfAnalytics")
...
public class MainView extends AppLayout {
    ...
    private static Tab[] getAvailableTabs() {
        ...
        tabs.add(createTab("Query", QueryDetailView.class));
